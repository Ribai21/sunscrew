...
const Hero = () => {
return (
    <section id="/" className="flex flex-col  p-3 md:p-0 items-center justify-center bg-no-repeat min-h-screen bg-cover bg-fixed  bg-center text-white" style={{ backgroundImage: `url(https://img.freepik.com/premium-photo/screws-pattern_87540-1393.jpg)` }}>
